...
# Support custom storage path for cloud deployments (set STORAGE_PATH env var)
_storage_root = os.environ.get('STORAGE_PATH', os.path.join(BASE_DIR, 'storage'))
DATA_FILE = os.path.join(_storage_root, 'data.dat')
BACKUP_DIR = os.path.join(BASE_DIR, 'backups')
CSV_DIR = os.path.join(_storage_root, 'csv')
